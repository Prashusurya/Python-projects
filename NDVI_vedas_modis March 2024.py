...
path=r'C:\Users\Admin\Desktop\all desktop files\NDVI vedas script\NDVI modis Vedas\NDVI modis latest data\NDVI jan 2FN 2024\\'
...
df=pd.read_excel(r"C:\Users\Admin\Desktop\all desktop files\NDVI vedas script\district-wise-lat-long_updated.xlsx", sheet_name='Uttar Pradesh')
time.sleep(1)
...
def year_loop(year):
    ...
    # for i in range(0,1850,50):
    for i in range(0,1850,1800):
